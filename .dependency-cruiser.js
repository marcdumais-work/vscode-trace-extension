...
module.exports = {
  forbidden: [
    ...
    /* rules you might want to tweak for your specific situation: */
    {
      ...
      severity: 'error',
      from: {
        pathNot: '^(vscode-trace-extension/src/test)'
      },
      to: {
        path: '^(vscode-trace-extension/src/test)'
      }
    },
    {
      name: 'not-to-spec',
    ...
    },
    {
      ...
      from: {
        path: '^(vscode-trace-extension/src/)',
  ...
  options: {
    ...
    */
     ...
     */
    // webpackConfig: {
    //  fileName: 'vscode-trace-extension/webpack.config.js',
    //  env: {},
    //  arguments: {}
    // },
...
// generated: dependency-cruiser@16.1.0 on 2024-01-29T23:18:40.553Z
